...
const PaymentPage = () => {
  ...
  return (
    ...
    >
      <Typography variant="h4" mb={3} sx={{ fontWeight: "bold", textAlign: "center" }} color="black">
        Pembayaran
      </Typography>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="h6" mb={2} sx={{ fontWeight: "bold" }} color="black">
          ...
          >
            ...
            <Box
                ...
                sx={{
                border: selectedMethod === method ? "2px solid #4caf50" : "2px solid #ddd",
                borderRadius: "8px",
                padding: "15px",
                cursor: "pointer",
                transition: "all 0.3s ease",
                "&:hover": {
                    border: selectedMethod !== method ? "2px solid #4caf50" : "2px solid #4caf50",
                },
                }}
            ...
            >
                ...
                <Box
                    ...
                    height: "12px",
                    borderRadius: "50%",
                    backgroundColor: selectedMethod === method ? "#4caf50" : "#f44336",
                    }}
                />
                <Image
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ padding: "20px", backgroundColor: "#fff" }}>
            ...
            <Box display="flex" justifyContent="space-between" mb={1}>
              <Typography>Total Harga ({productData.length} Produk):</Typography>
